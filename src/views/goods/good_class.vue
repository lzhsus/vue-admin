	...
	<section>
		...
		<template>
			<el-table :data="users" highlight-current-row max-height="800" height="800" v-loading="loading" style="width: 100%;">
				...
				<el-table-column align="center" prop="price" label="价格" min-width="100" sortable></el-table-column>				
                <el-table-column align="center" prop="class" label="种类" min-width="100" sortable></el-table-column>
				<el-table-column align="center" prop="sign" label="sign" min-width="100" sortable></el-table-column>
				<el-table-column align="center" prop="name" label="name" min-width="100" sortable></el-table-column>
				<el-table-column align="center" prop="page" label="page" min-width="100" sortable></el-table-column>
				<el-table-column align="center" prop="title" label="title" min-width="100" sortable></el-table-column>
